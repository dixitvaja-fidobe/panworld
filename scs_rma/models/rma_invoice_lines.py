...
class RmaInvoiceLines(models.Model):
    ...
    tax_id = fields.Many2many(
        "account.tax",
        "account_tax_rma_invoice_lines_rel",
        "rma_invoice_lines_id",
        "account_tax_id",
        string="Taxes"
    )
    ...
    def create(self, vals_list):
        res = super(RmaInvoiceLines, self).create(vals_list)
        for record in res:
    ...
    def default_get(self, fields):
        ...
        res.update(
            {
                "source_location_id": self.env.company.sup_source_location_id,
                "destination_location_id": self.env.company.sup_destination_location_id,
            }
        )
        return res
