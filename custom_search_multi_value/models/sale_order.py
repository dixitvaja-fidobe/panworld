...
class SaleOrder(models.Model):
    ...
    def _search_multi(self, operator, value):
        ...
        search_customer_sales_order = (
            self.env["ir.config_parameter"]
            .sudo()
            .get_param("custom_search_multi_value.search_customer_sales_order")
        )
        search_customer_sales_order = safe_eval(search_customer_sales_order)

        domain_list = []
        for search_field in search_customer_sales_order:
