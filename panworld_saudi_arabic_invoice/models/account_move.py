...
class AccountMove(models.Model):
    ...
    l10n_sa_show_delivery_date = fields.Boolean(compute='_compute_sa_show_delivery_date')
    ...
    in_supply_type = fields.Selection([
        ('material', 'Material Books'),
        ('subscription', 'Subscription'),
        ('both', 'Subscription/Material Books'),
    ])
    ...
    def _compute_sa_show_delivery_date(self):
        for move in self:
