...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    # Over right method to get Sale Order Reference for Request To Purchase Order
    @api.model
    def _prepare_purchase_order(self, picking_type, group_id, company, origin, customer_sales_order):
